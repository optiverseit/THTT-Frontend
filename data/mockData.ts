...
import { Service, Package, Testimonial, GalleryItem, BlogPost, VideoPost, TravelGuide } from '../types';
...
export const services: Service[] = [
  {  
    ...
    description: 'We offer the most competitive rates for both domestic flights within Nepal and international travel worldwide. Our real-time booking system ensures you get the best seats at the best prices with major carriers.',
    subServices: ['Domestic Air Ticket', 'International Air Ticket', 'Himalayan Sightseeing Flights', 'Charter Flights'],
    gallery: ['https://images.unsplash.com/photo-1544016768-982d1554f0b9?auto=format&fit=crop&q=80&w=600','https://images.unsplash.com/photo-1527004013197-933c4bb611b3?auto=format&fit=crop&q=80&w=1200',
...
export const packages: Package[] = [
   {
    ...
    highlights: ['Phewa Lake View', 'Annapurna Range', 'Expert Pilots', 'GoPro Footage'],
    price: '$85',
    ...
    isFeatured: true,
    testimonies: [
      { id: 'at1', userName: 'Emily Watson', rating: 5, date: '2024-06-01', comment: 'Floating above Pokhara was the highlight of my life!', location: 'USA' }
    ]
  },
  {
    id: 'a2',
    ...
    highlights: ['160m Drop', 'River Views', 'Safety Certified', 'Transport Included'],
    price: '$110',
    image: 'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200',
    category: 'domestic',
    type: 'activity',
    ...
    isFeatured: true,
    testimonies: [{ id: 'at1', userName: 'Emily Watson', rating: 5, date: '2024-06-01', comment: 'Floating above Pokhara was the highlight of my life!', location: 'USA' }]
  },
  {
    id: 'a3',
    ...
    highlights: ['Class III Rapids', 'River Side Camping', 'Professional Safety', 'Traditional Lunch'],
    price: '$45',
    image: 'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200',
    category: 'domestic',
    type: 'activity',
  ...
  // ✅ More Adventure Activities (type: "activity")
{
  ...
  duration: "1-2 Mins",
  location: "Sarangkot, Pokhara",
  highlights: ["World-class Zipline", "Mountain Views", "Safety Harness", "Transport Options"],
  price: "$70",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // zipline photo ID :contentReference[oaicite:1]{index=1}
  category: "domestic",
  type: "activity",
  adventureCategory: "Air",
  difficulty: "Moderate",
...
},
{
  ...
  highlights: ["Himalayan Trails", "Local Guide", "Helmet & Gear", "Scenic Viewpoints"],
  price: "$65",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // biking photo ID :contentReference[oaicite:2]{index=2}
  category: "domestic",
  type: "activity",
  adventureCategory: "Land",
  difficulty: "Hard",
...
},
{
  ...
  highlights: ["Certified Instructors", "Safety Gear Included", "Beginner Friendly", "Photo Moments"],
  price: "$55",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // climbing photo ID :contentReference[oaicite:3]{index=3}
  category: "domestic",
  type: "activity",
  adventureCategory: "Land",
  difficulty: "Moderate",
...
},
{
  ...
  duration: "1-2 Hours",
  location: "Pokhara, Nepal",
  highlights: ["Safety Briefing", "Life Jacket", "Scenic Paddle", "Great for Couples"],
  price: "$35",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // kayak photo ID :contentReference[oaicite:4]{index=4}
  category: "domestic",
  type: "activity",
  adventureCategory: "Water",
  difficulty: "Easy",
...
},
{
  ...
  highlights: ["Adrenaline Jump", "Safety Crew", "Photo/Video Option", "Short Hike Access"],
  price: "$95",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // bungee-style photo ID :contentReference[oaicite:5]{index=5}
  category: "domestic",
  type: "activity",
  adventureCategory: "Land",
  difficulty: "Extreme",
  ...
  }, 
{
  ...
  price: "$220",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // bungee gorge photo ID :contentReference[oaicite:6]{index=6}
  category: "domestic",
  type: "combo",
  adventureCategory: "Land",
  difficulty: "Hard",
...
},
{
  ...
  duration: "2 Days",
  location: "Trishuli River, Nepal",
  highlights: ["White Water Rafting", "Riverside Camping", "Kayak Session", "Local Meals"],
  price: "$120",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // Trishuli rafting photo ID :contentReference[oaicite:7]{index=7}
  category: "domestic",
  type: "combo",
  adventureCategory: "Water",
  difficulty: "Moderate",
...
},
{
  ...
  duration: "2 Days",
  location: "Pokhara, Nepal",
  highlights: ["Paragliding", "Mountain Biking", "Sunrise Viewpoint", "Comfort Stay"],
  price: "$195",
  image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&q=80&w=1200", // Pokhara paragliding photo ID :contentReference[oaicite:8]{index=8}
  category: "domestic",
  type: "combo",
  adventureCategory: "Air",
  difficulty: "Hard",
  ...
  }, 
{
  ...
  }, 
  {
    ...
    rating: 4.8,
    reviewsCount: 3,
    highlights: ['Lukla Flight', 'Namche Bazaar', 'Kalapathar Sunset', 'Base Camp Visit'],
    price: '$1,299',
    image: 'https://images.unsplash.com/photo-1527004013197-933c4bb611b3?auto=format&fit=crop&q=80&w=1200',
    gallery: [
    ...
    description: 'The Everest Base Camp trek is the most famous trek in the world. It leads you through the high-altitude landscapes of the Khumbu region, offering spectacular views of Mount Everest, Lhotse, and Nuptse. You will experience the rich Sherpa culture, visit ancient monasteries, and reach the base of the world\'s highest peak.',
    category: 'domestic',
    type: 'trek',
    isFeatured: true,
    itinerary: [
      { day: '01', title: 'Arrival in Kathmandu', desc: 'Our representative will meet you at the airport and transfer you to your hotel. Evening briefing about the trek.' },
      { day: '02', title: 'Fly to Lukla & Trek to Phakding', desc: 'An exciting flight to Lukla followed by a 3-4 hour trek through beautiful sherpa villages to Phakding.' },
      { day: '03', title: 'Trek to Namche Bazaar', desc: 'Entering the Sagarmatha National Park and crossing the famous Hillary Bridge to reach the vibrant town of Namche.' },
      { day: '04', title: 'Acclimatization Day', desc: 'Hike to Everest View Hotel for the first glimpse of Mt. Everest and visit the local museum.' },
      { day: '05', title: 'Namche to Tengboche', desc: 'A scenic trail leading to the famous Tengboche Monastery with 360-degree mountain views.' }
    ],
    includes: [
    ...
    faqs: [
      { question: 'What is the best time to trek?', answer: 'The best seasons are Spring (March to May) and Autumn (September to November).' },
      { question: 'Do I need previous experience?', answer: 'While no technical climbing skills are needed, a good level of physical fitness is required.' }
    ],
    pricingTable: [
      { service: 'Full EBC Trek Package', ageGroup: 'Adult', priceNepali: 'Rs 120,000', priceForeigner: '$1,299' },
      { service: 'Heli Return Add-on', ageGroup: 'All', priceNepali: 'Rs 50,000', priceForeigner: '$500' }
    ],
    testimonies: [
      { id: 'rev1', userName: 'Mark Wilson', rating: 5, date: '2024-05-12', comment: 'An absolute dream come true. The guide from Trip Himalaya was incredibly knowledgeable and helpful.', userAvatar: 'https://i.pravatar.cc/150?u=mark', location: 'Sydney, Australia' },
      { id: 'rev2', userName: 'Sarah Jenkins', rating: 4, date: '2024-04-20', comment: 'Challenging but rewarding. The views from Kalapathar are something I will never forget.', userAvatar: 'https://i.pravatar.cc/150?u=sarah', location: 'London, UK' },
      { id: 'rev3', userName: 'Carlos Ruiz', rating: 5, date: '2024-03-15', comment: 'Top notch service from start to finish. Everything was well organized.', userAvatar: 'https://i.pravatar.cc/150?u=carlos', location: 'Madrid, Spain' }
    ]
  },
  {
    id: 'p2',
    ...
    highlights: ['Natural Hot Springs', 'Annapurna Massif Views', 'Ghandruk Village', 'Cultural Immersion'],
    price: '$899',
    ...
    isFeatured: true,
    itinerary: [
      { day: '01', title: 'Drive to Nayapul & Trek to Tikhedhunga', desc: 'A scenic drive from Pokhara followed by an easy trek to start our journey.' },
      { day: '02', title: 'Trek to Ghorepani', desc: 'The famous 3000 stone steps of Ulleri lead us to the beautiful rhododendron forest of Ghorepani.' },
      { day: '03', title: 'Poon Hill Sunrise & Trek to Tadapani', desc: 'Early morning hike for a panoramic sunrise view of Dhaulagiri and Annapurna ranges.' }
    ],
    testimonies: [{ id: 'rev1', userName: 'Mark Wilson', rating: 5, date: '2024-05-12', comment: 'An absolute dream come true. The guide from Trip Himalaya was incredibly knowledgeable and helpful.', userAvatar: 'https://i.pravatar.cc/150?u=mark', location: 'Sydney, Australia' },
      { id: 'rev2', userName: 'Sarah Jenkins', rating: 4, date: '2024-04-20', comment: 'Challenging but rewarding. The views from Kalapathar are something I will never forget.', userAvatar: 'https://i.pravatar.cc/150?u=sarah', location: 'London, UK' },
      { id: 'rev3', userName: 'Carlos Ruiz', rating: 5, date: '2024-03-15', comment: 'Top notch service from start to finish. Everything was well organized.', userAvatar: 'https://i.pravatar.cc/150?u=carlos', location: 'Madrid, Spain' }
    ]
  },
  {
    ...
    slug: 'mardi-himal',
    duration: '7 Days',
    highlights: ['Close View of Machhapuchhre', 'High Camp Overnight', 'Rhododendron Forests', 'Pokhara City Stay'],
    price: '$550',
  ...
  },
  {
    ...
    slug: 'bali-escape',
    duration: '4 Days',
    highlights: ['Uluwatu Sunset', 'Ubud Rice Terrace', 'Luxury Beach Resort', 'Water Sports'],
    price: '$1,150',
    image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=1200',
    ...
    isFeatured: true,
     itinerary: [
      { day: '01', title: 'Arrival & Beach Sunset', desc: 'Transfer to your luxury beachfront villa in Seminyak. Evening seafood dinner on the beach.' },
      { day: '02', title: 'Cultural Ubud Tour', desc: 'Visit the Sacred Monkey Forest, Tegalalang Rice Terraces, and traditional art markets.' },
      { day: '03', title: 'Water Sports & Uluwatu', desc: 'Morning paragliding and jet-skiing followed by a visit to the cliffside Uluwatu temple for Kecak dance.' }
    ],
    testimonies: [{ id: 'rev1', userName: 'Mark Wilson', rating: 5, date: '2024-05-12', comment: 'An absolute dream come true. The guide from Trip Himalaya was incredibly knowledgeable and helpful.', userAvatar: 'https://i.pravatar.cc/150?u=mark', location: 'Sydney, Australia' },
      { id: 'rev2', userName: 'Sarah Jenkins', rating: 4, date: '2024-04-20', comment: 'Challenging but rewarding. The views from Kalapathar are something I will never forget.', userAvatar: 'https://i.pravatar.cc/150?u=sarah', location: 'London, UK' },
      { id: 'rev3', userName: 'Carlos Ruiz', rating: 5, date: '2024-03-15', comment: 'Top notch service from start to finish. Everything was well organized.', userAvatar: 'https://i.pravatar.cc/150?u=carlos', location: 'Madrid, Spain' }
  ...
  },
  {
    ...
    duration: '6 Days',
    highlights: ['Lakeside Evening', 'Elephant Safari', 'Tharu Cultural Show', 'Himalayan Sunrise'],
    price: '$450',
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=1600',
    category: 'domestic',
    type: 'tour',
  ...
  },
  {
    ...
    slug: 'dubai-tour',
    duration: '5 Days',
    highlights: ['Burj Khalifa Visit', 'Desert Safari', 'Marina Cruise', 'Gold Souk Shopping'],
    price: '$899',
  ...
  duration: '8 Days',
  highlights: ['Kyanjin Gompa', 'Langtang Lirung Views', 'Tamang Culture', 'Yak Cheese Factory'],
  price: '$650',
...
},
{
  ...
  slug: 'poon-hill',
  duration: '5 Days',
  highlights: ['Poon Hill Sunrise', 'Annapurna Views', 'Rhododendron Forest', 'Short & Easy Trek'],
  price: '$399',
...
},
{
  ...
  slug: 'upper-mustang',
  duration: '14 Days',
  highlights: ['Lo Manthang', 'Ancient Caves', 'Restricted Kingdom', 'Trans-Himalayan Desert'],
  price: '$2,200',
  image: 'https://images.unsplash.com/photo-1605540436563-5bca919ae766?auto=format&fit=crop&q=80&w=1200',
  category: 'domestic',
  type: 'trek',
...
},
{
  ...
  duration: '16 Days',
  highlights: ['Larkya La Pass', 'Remote Villages', 'Less Crowded Route', 'Manaslu Range'],
  price: '$1,350',
  image: 'https://images.unsplash.com/photo-1583267746897-2cf415887172?auto=format&fit=crop&q=80&w=1200',
  category: 'domestic',
  type: 'trek',
...
},
{
  ...
  slug: 'ktm-heritage',
  duration: '3 Days',
  highlights: ['Pashupatinath', 'Boudhanath Stupa', 'Bhaktapur Durbar Square', 'Swayambhunath'],
  price: '$250',
...
},
{
  ...
  slug: 'everest-flight',
  duration: '1 Day',
  highlights: ['Aerial Everest View', 'Guaranteed Window Seat', 'Short Time Commitment'],
  price: '$240',
...
},
{
  ...
  slug: 'thailand-tour',
  duration: '7 Days',
  highlights: ['Bangkok City Tour', 'Phi Phi Islands', 'Night Markets', 'Island Hopping'],
  price: '$1,050',
...
},
{
  ...
  slug: 'singapore-city',
  duration: '4 Days',
  highlights: ['Marina Bay Sands', 'Sentosa Island', 'Universal Studios', 'City Skyline'],
  price: '$1,200',
  image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&q=80&w=1200',
  category: 'international',
  type: 'tour',
...
},
{
  ...
  duration: '5 Days',
  highlights: ['Overwater Villa', 'Snorkeling', 'Private Beach', 'Luxury Resorts'],
  price: '$2,500',
...
},
{
  ...
  slug: 'japan-sakura',
  duration: '8 Days',
  highlights: ['Tokyo & Kyoto', 'Sakura Season', 'Cultural Experience', 'Bullet Train'],
  price: '$2,100',
...
},
{
  ...
  slug: 'rara-lake',
  duration: '10 Days',
  highlights: ['Nepal’s Largest Lake', 'Remote Karnali Region', 'Pristine Nature'],
  price: '$1,100',
...
},
{
  ...
  slug: 'bardiya-safari',
  duration: '4 Days',
  highlights: ['Tiger Tracking', 'River Rafting', 'Wildlife Safari', 'Tharu Culture'],
  price: '$420',
  image: 'https://images.unsplash.com/photo-1552083375-1447ce886485?auto=format&fit=crop&q=80&w=1200',
  category: 'domestic',
  type: 'tour',
  isFeatured: false,
  testimonies: []
...
export const testimonials: Testimonial[] = [
  {
    ...
    message: 'Trip Himalaya made our EBC trek absolutely unforgettable. The organization was top-notch!',
    rating: 5,
  ...
  },
  {
    ...
    name: 'Anita Sharma',
    country: 'Nepal',
    message: 'Best service for domestic air tickets. Highly recommended for their prompt response.',
    rating: 5,
  ...
  },
  {
    ...
    name: 'David Smith',
    country: 'USA',
    message: 'Amazing hospitality and expert guidance. They handled our visa and hotel bookings seamlessly.',
    rating: 5,
...
export const galleryItems: GalleryItem[] = [
  { id: 'g1', category: 'tour', image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=1600', title: 'Mountain Tour' },
  { id: 'g2', category: 'vehicle', image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=1200', title: 'Our Private Van' },
  { id: 'g3', category: 'activity', image: 'https://images.unsplash.com/photo-1533130061792-64b345e4a833?auto=format&fit=crop&q=80&w=1200', title: 'Paragliding in Pokhara' },
  { id: 'g4', category: 'office', image: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80&w=1200', title: 'Our KTM Office' }
];
export const workPermitCountries = [
  { id: 'uae', name: 'UAE', flag: '🇦🇪', desc: 'Complete processing for Dubai, Abu Dhabi & more.',backgroundImage: "../data/image/uae.png" },
  { id: 'qatar', name: 'Qatar', flag: '🇶🇦', desc: 'Hassle-free work permit for Qatar jobs.',backgroundImage: "../data/image/qatar.png" },
  { id: 'saudi', name: 'Saudi Arabia', flag: '🇸🇦', desc: 'Expert assistance for KSA work permits.',backgroundImage: "../data/image/saudi.png" },
  { id: 'malaysia', name: 'Malaysia', flag: '🇲🇾', desc: 'Fast processing for Malaysia employment.',backgroundImage: "../data/image/malaysia.png" },
  { id: 'other', name: 'Other Countries', flag: '🌐', desc: 'Support for various other global destinations.',backgroundImage: "../data/image/other.png" }
];
...
export const visaDetails = {
  uae: {
    ...
    overview:
      "UAE tourist and visit visas processed with fast turnaround. Suitable for tourism, family visits, and short-term stays.",
    validity: "30 / 60 Days",
  ...
  australia: {
    ...
    flag: "🇦🇺",
    heroImage:
      "https://images.unsplash.com/photo-1506973035872-a4f23ad4b6c5?auto=format&fit=crop&q=80&w=2000",
    overview:
      "Australia visitor and student visa support with documentation assistance and embassy guidance.",
...
export const visaServiceTestimonials = [
  {
    id: "vs1",
    name: "Anita Gurung",
    ...
    rating: 5,
    message:
      "Trip Himalaya guided me through my student visa process step-by-step. The document checklist and SOP review were extremely helpful. I received my visa without delays.",
    avatar:
  ...
  },
  {
    id: "vs2",
    name: "Deepak Rai",
    country: "Canada (Visit Visa)",
    rating: 5,
    message:
      "I had a previous refusal and was unsure about applying again. Their team reviewed my profile carefully, corrected my documents, and this time my visa was approved.",
    avatar:
  ...
  },
  {
    id: "vs3",
    name: "Mina Shrestha",
    country: "UK (Tourist Visa)",
    rating: 4,
    message:
      "Very professional and transparent process. They explained financial documentation clearly and kept me updated throughout. The timeline matched what they promised.",
    avatar:
  ...
  },
  {
    id: "vs4",
    name: "Rajesh Thapa",
    country: "USA (Business Visa)",
    rating: 5,
    message:
      "From DS-160 form filling to interview preparation, everything was handled properly. Their mock interview session boosted my confidence and helped me succeed.",
    avatar:
...
export const visaCountries = [
  ...
  
  {
    ...
    name: "UK",
    flag: "🇬🇧",
    desc: "Visit & Business Visa",
  },
  {
    id: "canada",
    name: "Canada",
    flag: "🇨🇦",
    desc: "Study & Visitor Visa",
  },{
    id: "australia",
    name: "Australia",
    flag: "🇦🇺",
    desc: "Student & Tourist Visa",
  },
  {
    id: "schengen",
    name: "Schengen",
    flag: "🇪🇺",
    desc: "26 European Countries",
  },
];
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Planning your first trek to the roof of the world? Here is everything you need to know about packing, training, and altitude.',
  ...
  },
  {
    ...
    excerpt: 'Experience the spiritual side of Bali with our guide to hidden temples, local art markets, and traditional ceremonies.',
    category: 'INTERNATIONAL',
  ...
  },
  {
    ...
    slug: 'travel-insurance-guide',
    excerpt: 'Safety first! Learn why specific mountain coverage is vital for your high-altitude adventures in Nepal.',
  ...
  },
  {
    ...
    excerpt: 'Getting your entry permit at Kathmandu airport is easier than ever with our step-by-step documentation guide.',
    category: 'VISA ASSISTANCE',
    author: 'Legal Desk',
    date: 'Nov 17, 2024',
    image: 'https://images.unsplash.com/photo-1554931670-4ebfabf6e7a9?auto=format&fit=crop&q=80&w=800',
    readTime: '4 min read'
  },
  {
    id: 'b5',
    ...
    excerpt: 'Short on time but want the big views? The Annapurna Base Camp Helicopter tour is the ultimate luxury experience.',
    category: 'LUXURY',
    author: 'Tour Guide',
    date: 'Nov 10, 2024',
...
export const videoPosts: VideoPost[] = [
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&q=80&w=1600',
    category: 'ADVENTURE',
    duration: '12:45',
    views: '15.4K',
    date: 'Oct 12, 2025',
    author: 'Sam Adventures',
    description: 'Join our team as we navigate the iconic trails to the base of the world\'s highest peak.',
  ...
  },
  {
    ...
    date: 'Sept 05, 2025',
    author: 'Maya Travel',
    description: 'Discover the lakeside serenity and mountain views of Nepal\'s tourism capital.',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1527004013197-933c4bb611b3?auto=format&fit=crop&q=80&w=1600',
    category: 'WILDLIFE',
    duration: '06:15',
    views: '12.1K',
    date: 'Aug 22, 2025',
    author: 'Eco Wild',
    description: 'Tracking the One-Horned Rhino and Royal Bengal Tiger in the heart of the jungle.',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1544016768-982d1554f0b9?auto=format&fit=crop&q=80&w=1200',
    category: 'LUXURY',
    duration: '04:30',
    views: '5.6K',
    date: 'July 14, 2025',
    author: 'Elite Tours',
    description: 'Experience the Annapurna range like never before with our luxury helicopter tour.',
