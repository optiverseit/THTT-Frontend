  ...
  return (
    <div className="w-full bg-[#FBFBFE]">
      ...
      >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-5">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight drop-shadow-sm leading-tight">
                  {pkg.title}
                </h1>
                <span className={`${categoryColor} text-white text-[11px] font-black uppercase px-2.5 py-0.5 rounded-full shadow-sm`}>
                  {categoryLabel}
                </span>
              </div>
        ...
        {/* CTA Buttons — bottom-right, above share */}
        <div className="print:hidden absolute bottom-24 right-14 z-10 flex flex-col items-center gap-1.5">
          <button
        ...
        <div className="absolute bottom-4 right-14 z-10">
          {isShareOpen && (
            <div className="absolute bottom-0 right-11 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/80 p-2 flex items-center gap-1.5 min-w-max">
              {/* Facebook */}
              <button
                onClick={() => {
